...
class AYUSHRecommendationSystem:
    ...
    def load_data(self):
        ...
        self.patients = pd.read_csv('/home/claude/patients.csv')
        self.health_records = pd.read_csv('/home/claude/health_records.csv')
        self.treatments = pd.read_csv('/home/claude/treatments.csv')
    ...
    def save_models(self):
        """Save trained models"""
        print("\nSaving models...")
        joblib.dump(self.outcome_model, '/home/claude/outcome_model.pkl')
        joblib.dump(self.improvement_model, '/home/claude/improvement_model.pkl')
        joblib.dump(self.scaler, '/home/claude/scaler.pkl')
        joblib.dump(self.label_encoders, '/home/claude/label_encoders.pkl')
