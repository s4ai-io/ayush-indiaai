...
- For registration fields (name, age, mobile, address, etc.), extract them EXACTLY as spoken.
- For clinical fields (symptoms, diagnosis, prakriti, etc.), use medical judgment.
- Translate any Hindi, Gujarati, or regional language input to English internally.
